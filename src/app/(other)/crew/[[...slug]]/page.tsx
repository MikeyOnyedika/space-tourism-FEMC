...
export default function Crew({
  ...
  return (
    <section className="w-full h-full flex flex-col items-center gap-8 justify-between pb-6 md:pb-10 pr-6 md:pr-10 pl-6 md:pl-10">
      <section className="w-full flex flex-col gap-6 pt-10 max-w-[32rem]">
        <section className="flex flex-col gap-6">
          ...
          <p className="text-center text-[0.94rem] leading-[180%] min-h-[10.8em] md:text-base   md:leading-[180%] md:min-h-[7.2em] ">{crewMember.bio}</p>
        </section>
